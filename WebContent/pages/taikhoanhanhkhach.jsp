...
<%
	...
	String trangDanhSach = "index.jsp?p=pages/taikhoanhanhkhachs.jsp";
...
<%
	...
	TaiKhoanHanhKhach obj = null;
	if (session.getAttribute("obj") != null) {
		if (session.getAttribute("obj") instanceof TaiKhoanHanhKhach) {
			obj = (TaiKhoanHanhKhach) session.getAttribute("obj");
		}
	}
%>
<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									<label>Mã hành khách</label> <input class="form-control"
										name="maHanhKhach"
										value="<%=(obj != null && obj.getHanhKhach() != null ? obj.getHanhKhach().getMaHanhKhach() : "")%>"
										<%=(modeView ? " disabled " : "")%>>
								</div>
								<div class="form-group">

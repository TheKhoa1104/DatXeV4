...
public String toString() {
	return "ChucNang [maChucNang=" + maChucNang + ", tenHienThi=" + tenHienThi + ", duongDan=" + duongDan + ", hinhAnh="
			+ hinhAnh + ", moTa=" + moTa + ", ghiChu=" + ghiChu + ", ChucNangCha=" + ChucNangCha + ", thoiGianCapNhat="
			+ thoiGianCapNhat + "]";
}

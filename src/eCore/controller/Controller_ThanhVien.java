...
import eCore.modelDao.DAO_ThanhVien;
...
public class Controller_ThanhVien extends ThanhVien implements ZEController {
	...
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eCore/pages/thanhviens.jsp";
	String duongDanTrangView = "eCore/pages/thanhvien.jsp";
	...
	public Date getNgaySinh() {
		return eCore.util.Util_Date.stringToDate(getS_ngaySinh());
	}
	...
	public String viewDetail() {
		...
		ArrayList<eCore.model.ThanhVien> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
